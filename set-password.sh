...
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"briquser"}
...
db.createUser({user: '$MONGODB_APPLICATION_USER', pwd: '$MONGODB_APPLICATION_PASS', roles:[{role:'userAdmin', db:'$MONGODB_APPLICATION_DATABASE'},{role:'dbAdmin', db:'$MONGODB_APPLICATION_DATABASE'},{role:'readWrite', db:'$MONGODB_APPLICATION_DATABASE'},{role:'dbOwner', db:'$MONGODB_APPLICATION_DATABASE'}]})
EOF
fi
